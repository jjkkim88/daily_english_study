...
export default async function SentencesPage({
  ...
  const p = await readSourcePaged('english_sentences.md', page, 50);

  return (
    <div className="space-y-4">
      <div>
        <div className="text-2xl font-extrabold tracking-tight">Sources: Sentences</div>
      ...
      <Card>
        ...
        <CardContent>
          <PageNav base="/sources/sentences" page={p.page} totalPages={p.totalPages} />
